  d3.select("body").append("div").attr("class","title").attr("id","title").html("you are here")
  d3.select("body").append("div").attr("class","section").attr("id","coordinates").html("coordinates")
  d3.select("body").append("div").attr("class","section").attr("id","orientation").html("orientation")
